...
ADD_CES: dict[Region, dict[int, tuple[str | None,]]] = {
    ...
    Region.KR: {
        ...
        # 23970: ("田",),  # Fate/Grand Order 藤丸立香はわからない 9310560, No.2402 for other regions
    },
    # 2017.06
    Region.NA: {
    ...
    Region.CN: {
        ...
        102027: ("STAR影法師",),  # 10th 90086009
        102028: ("リヨ",),  # 10th 90086010
        102029: ("武内崇",),  # 10th CE: 英灵星行：阿尔托莉雅·潘德拉贡
    },
}
...
DESTINY_ORDER_CLASSES: dict[str, list[int]] = {
    ...
    "50042541": [1, 2, 3, 4, 5, 6, 7],
    "2026_08_11th_destiny_1": [1, 2, 3, 4, 5, 6, 7],
    "50042551": [9, 11, 10, 23, 25, 28, 33],
    "2026_08_11th_destiny_2": [9, 11, 10, 23, 25, 28, 33],
}
...
_GRAND_DUEL_QUEST_REMAP: dict[int, int] = (
    ...
    | {94150811 + i: 94150841 + i for i in range(7)}  # Grand Archer
...
SUB_EVENTS: dict[int, list[int]] = {
    80557: [80569, 80560, 80561, 80562, 80563, 80564, 80565, 80566, 80567, 80568],
    80613: [80615, 80616, 80617, 80618, 80619, 80620, 80621, 80622, 80623],
}

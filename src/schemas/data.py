...
SVT_LIMIT_HIDES: dict[int, list[SvtLimitHide]] = {
    ...
    800100: [
        SvtLimitHide(
            ...
            activeSkills={1: [459550, 744450, 2476450], 2: [460250, 2550, 970660], 3: [457000, 2162350, 133550]},
        ),
        SvtLimitHide(
            ...
            activeSkills={1: [1000, 236000, 2476450], 2: [2000, 2550, 970660], 3: [133000, 133550]},
        ),
        SvtLimitHide(
            limits=[17, 800190, 19, 800200],
            tds=[800100, 800101, 800104, 800102, 800105, 800106, 800108, 800196, 800197],
            activeSkills={1: [1000, 236000, 459550, 744450], 2: [2000, 460250, 970660], 3: [133000, 457000, 2162350]},
        ),
    ],
    304800: [
        SvtLimitHide(

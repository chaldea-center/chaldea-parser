...
def parse_exchange_tickets(nice_item: list[NiceItem]) -> list[ExchangeTicket]:
    ...
    replaced: dict[int, MappingBase[list[int]]] = {
        202003: MappingBase[list[int]](CN=[6537, 6514, 6534]),
        202004: MappingBase[list[int]](CN=[6535, 6526, 6530]),
        202006: MappingBase[list[int]](NA=[6538, 6547, 6527]),  # 2 鬼灯-线球
        202007: MappingBase[list[int]](NA=[6535, 6509, 6549]),  # 3 黑灰-小钟
        202008: MappingBase[list[int]](NA=[6537, 6526, 6550]),  # 3 树种-鳞粉
        202012: MappingBase[list[int]](NA=[6537, 6550, 6527]),  # 2 鬼灯-鳞粉
        202102: MappingBase[list[int]](NA=[6538, 6526, 6549]),  # 3 龙牙-小钟
        202206: MappingBase[list[int]](CN=[]),
        202207: MappingBase[list[int]](CN=[]),
        202208: MappingBase[list[int]](CN=[]),  # CN skip 3 months
    }
